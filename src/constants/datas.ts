import normalCoffee from '@/assets/images/normalCoffee.webp'
import americanCoffee from '@/assets/images/americanCoffee.webp'
import creamCoffee from '@/assets/images/creamCoffee.webp'
import gelateCoffee from '@/assets/images/gelatteCoffee.webp'
import latteeWcoffee from '@/assets/images/latteeWcoffee.webp'
import lateCoffee from '@/assets/images/lateCoffee.webp'
import capuccino from '@/assets/images/capuccino.webp'
import macchiato from '@/assets/images/macchiato.webp'
import mocacchino from '@/assets/images/mocacchino.webp'
import chocolate from '@/assets/images/chocolate.webp'
import cuban from '@/assets/images/cuban.webp'
import havawain from '@/assets/images/havawain.webp'
import arabe from '@/assets/images/arabe.webp'
import irlandes from '@/assets/images/irlandes.webp'
...
export const coffeesApi = [
  ...
  },
  {
    ...
    name: 'Latte',
    description:
      'One dose of coffee express with the double milk de leite and cream foan',
    price: 9.9,
    img: lateCoffee,
    amount: 1,
    total: 0,
  ...
  },
  {
    ...
    name: 'Cuban',
    description:
      'Cold drink of express coffee with rum, milk cream and hortela',
    price: 9.9,
    img: cuban,
    amount: 1,
    total: 0,
